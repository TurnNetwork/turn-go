...
import (
	"bytes"
	"errors"
	"github.com/bubblenet/bubble/core/state/pruner"
	"time"
...
`,
			},
			{
				...
				Description: `
bubble snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
bubble snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
bubble snapshot traverse-rawstate <state-root>
