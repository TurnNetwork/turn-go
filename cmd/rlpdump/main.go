...
var (
	errCode = flag.String("errCode", "", "dump given bubble dpos tx receipt errCode description")
	inner   = flag.String("inner", "", "dump given bubble inner contract data with `bubble.Call`")
...
func main() {
	...
	// parse bubble dpos tx receipt errCode
	...
	// parse bubble inner contract data
	if *inner != "" {
