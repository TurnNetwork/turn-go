...
var (
	...
	mulSignerPrefix           = []byte("multi-signer-")            // Multi-signature verifier config prefix for the db
...
// mulSignerKey = mulSignerPrefix + hash
func mulSignerKey(hash common.Hash) []byte {
	return append(mulSignerPrefix, hash.Bytes()...)
}
