...
import (
	...
	state2 "github.com/bubblenet/bubble/core/state"
	"github.com/bubblenet/bubble/core/types"
	cvm "github.com/bubblenet/bubble/core/vm"
...
func parallelMode(t testing.TB, testTxList types.Transactions, blockchain *BlockChain, stateDb *state2.StateDB, header *types.Header, tempContractCache map[common.Address]struct{}) *types.Block {
	...
	ctx := NewParallelContext(stateDb, header, common.Hash{}, gp, true, types.MakeSigner(chainConfig), tempContractCache)
