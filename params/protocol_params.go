...
const (
	...
	TokenGas              uint64 = 2000  // Gas needed for precompiled contract: TokenContract
	MintTokenGas          uint64 = 32000 // Gas needed for precompiled contract: TokenContract
	SettleBubbleGas       uint64 = 32000 // Gas needed for precompiled contract: TokenContract
	...
	AddLineOfCreditGas          uint64 = 8000  // Gas needed for AddLineOfCreditGas
	...
	BubbleGas               uint64 = 3000
	RemoteDeployExecutorGas uint64 = 21000
	RemoteRemoveExecutor    uint64 = 21000
	RemoteDestroyExecutor   uint64 = 32000
