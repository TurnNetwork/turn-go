...
import (
	...
	"github.com/bubblenet/bubble/internal/testlog"
	"github.com/bubblenet/bubble/log"
	"github.com/bubblenet/bubble/p2p/discover/v4wire"
...
func TestUDPv4_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, &v4wire.Ping{From: testRemote, To: testLocalAnnounced, Version: 4, ForkID: cRest})
	test.packetIn(errUnsolicitedReply, &v4wire.Pong{ReplyTok: []byte{}, Expiration: futureExp, ForkID: cRest})
...
func (req testPacket) Fork() []rlp.RawValue { return cRest }
...
func TestUDPv4_pingMatch(t *testing.T) {
	...
	test.packetIn(nil, &v4wire.Ping{From: testRemote, To: testLocalAnnounced, Version: 4, Expiration: futureExp, ForkID: cRest})
	test.waitPacketOut(func(*v4wire.Pong, *net.UDPAddr, []byte) {})
	test.waitPacketOut(func(*v4wire.Ping, *net.UDPAddr, []byte) {})
	test.packetIn(errUnsolicitedReply, &v4wire.Pong{ReplyTok: randToken, To: testLocalAnnounced, Expiration: futureExp, ForkID: cRest})
}
...
func TestUDPv4_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, &v4wire.Ping{From: testRemote, To: testLocalAnnounced, Version: 4, Expiration: futureExp, ForkID: cRest})
	...
	test.waitPacketOut(func(p *v4wire.Ping, to *net.UDPAddr, hash []byte) {
		...
		test.packetIn(nil, &v4wire.Pong{ReplyTok: hash, Expiration: futureExp, ForkID: cRest})
	})
...
/*func TestUDPv4_EIP868(t *testing.T) {
	...
	test.packetIn(nil, &v4wire.Ping{Expiration: futureExp, ForkID: cRest})
	...
	test.waitPacketOut(func(p *v4wire.Ping, addr *net.UDPAddr, hash []byte) {
		...
		test.packetIn(nil, &v4wire.Pong{Expiration: futureExp, ReplyTok: hash, ForkID: cRest})
	})

	// Request should work now.
	test.packetIn(nil, &v4wire.ENRRequest{Expiration: futureExp, Rest: cRest})
