...
func (h *ethHandler) Handle(peer *eth.Peer, packet eth.Packet) error {
	...
	case *eth.PposStoragePack:
		return h.downloader.DeliverDposStorage(peer.ID(), packet.KVs, packet.Last, packet.KVNum)

	case *eth.OriginAndPivotPack:
		return h.downloader.DeliverOriginAndPivot(peer.ID(), *packet)

	case *eth.PposInfoPack:
		return h.downloader.DeliverDposInfo(peer.ID(), packet.Latest, packet.Pivot)
