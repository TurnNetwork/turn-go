...
func makeChain(n int, seed byte, parent *types.Block, empty bool) ([]*types.Block, []types.Receipts) {
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, consensus.NewFaker(), testdb, n, func(i int, block *core.BlockGen) {
...
func TestBasics(t *testing.T) {
	...
	// The receipt is not synchronized in bubble SnapSync mode, so it is 0 here
